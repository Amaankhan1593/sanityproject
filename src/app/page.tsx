    ...
    <div className="hidden lg:block hover:underline">
      <ul className="flex items-center ">
        ...
        <li className="group pl-6">
          <span
            className="cursor-pointer pt-0.5 hover:underline font-header font-semibold uppercase text-white"
            >About</span>
        ...
        <li className="group pl-6">
          ...
          <span
            className="cursor-pointer hover:underline pt-0.5 font-header font-semibold uppercase text-white"
            >Clients
            </span>
